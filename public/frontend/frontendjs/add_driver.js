...
//validation and from submit js

 $("form#add-driver").submit(function(){
            ...
            if($.trim($("#drivername").val())==''){
                    ...
                    $('html, body').animate({scrollTop: $("#drivername").offset().top }, 1000);
                    ...
                    $("#submit").attr("disabled", false);
                    $('html, body').animate({scrollTop: $("#mobileno").offset().top }, 1000);
                    ...
                    $("#submit").attr("disabled", false);
                    $('html, body').animate({scrollTop: $("#nationality").offset().top }, 1000);
                    ...
                    $("#submit").attr("disabled", false);
                    $('html, body').animate({scrollTop: $("#caddress").offset().top }, 1000);
                    ...
                    $("#submit").attr("disabled", false);
                    $('html, body').animate({scrollTop: $("#ccity").offset().top }, 1000);
                    ...
                    $("#submit").attr("disabled", false);
                    $('html, body').animate({scrollTop: $("#cstate").offset().top }, 1000);
                    ...
                    $("#submit").attr("disabled", false);
                    $('html, body').animate({scrollTop: $("#ccountry").offset().top }, 1000);
                    ...
                    $("#submit").attr("disabled", false);
                    $('html, body').animate({scrollTop: $("#cpobox").offset().top }, 1000);
                    ...
                    $("#submit").attr("disabled", false);
                    $('html, body').animate({scrollTop: $("#crefname").offset().top }, 1000);
                    ...
                    $("#submit").attr("disabled", false);
                    $('html, body').animate({scrollTop: $("#crefno").offset().top }, 1000);
                    ...
                    $("#submit").attr("disabled", false);
                    $('html, body').animate({scrollTop: $("#paddress").offset().top }, 1000);
                    ...
                    $("#submit").attr("disabled", false);
                    $('html, body').animate({scrollTop: $("#pcity").offset().top }, 1000);
                    ...
                    $("#submit").attr("disabled", false);
                    $('html, body').animate({scrollTop: $("#pstate").offset().top }, 1000);
                    ...
                    $("#submit").attr("disabled", false);
                    $('html, body').animate({scrollTop: $("#pcountry").offset().top }, 1000);
                    ...
                    $("#submit").attr("disabled", false);
                    $('html, body').animate({scrollTop: $("#ppobox").offset().top }, 1000);
                    ...
                    $("#submit").attr("disabled", false);
                    $('html, body').animate({scrollTop: $("#prefname").offset().top }, 1000);
                    ...
                    $("#submit").attr("disabled", false);
                    $('html, body').animate({scrollTop: $("#prefno").offset().top }, 1000);
                    ...
                    $("#submit").attr("disabled", false);
                    $('html, body').animate({scrollTop: $("#passportissuedate").offset().top }, 1000);
                    ...
                    $("#submit").attr("disabled", false);
                    $('html, body').animate({scrollTop: $("#passportexpiredate").offset().top }, 1000);
                    ...
                    $("#submit").attr("disabled", false);
                    $('html, body').animate({scrollTop: $("#nationalidissuedate").offset().top }, 1000);
                    ...
                    $("#submit").attr("disabled", false);
                    $('html, body').animate({scrollTop: $("#nationalidexpiredate").offset().top }, 1000);
                    ...
                    $("#submit").attr("disabled", false);
                    $('html, body').animate({scrollTop: $("#drivinglicissuedate").offset().top }, 1000);
                    ...
                    $("#submit").attr("disabled", false);
                    $('html, body').animate({scrollTop: $("#drivinglicexpiredate").offset().top }, 1000);
                    ...
                    $("#submit").attr("disabled", false);
                    $('html, body').animate({scrollTop: $("#visaissuedate").offset().top }, 1000);
                    ...
                    $("#submit").attr("disabled", false);
                    $('html, body').animate({scrollTop: $("#visaexpiredate").offset().top }, 1000);
