...
$("form#add-driver").submit(function() {
 ...
 if ($.trim($("#drivername").val()) == '') {
  ...
  $("#submit").attr("disabled", false);
  $('html, body').animate({
   scrollTop: $("#driverimage").offset().top
  }, 1000);
  ...
  $("#submit").attr("disabled", false);
  $('html, body').animate({
   scrollTop: $("#passportimage").offset().top
  }, 1000);
  ...
  $("#submit").attr("disabled", false);
  $('html, body').animate({
   scrollTop: $("#nationalidimage").offset().top
  }, 1000);
  ...
  $("#submit").attr("disabled", false);
  $('html, body').animate({
   scrollTop: $("#drivinglicimage").offset().top
  }, 1000);
  ...
  $("#submit").attr("disabled", false);
  $('html, body').animate({
   scrollTop: $("#visaimage").offset().top
  }, 1000);
