...
<body>
            ...
            <div class="mg-t-20 w-100"></div>
                <div class="col-lg-12">            
                    <div class="card shadow-base bd-0 pd-25 ">                        
                        <h6 class="tx-inverse tx-uppercase tx-bold tx-14 mg-t-10">Dustbin History 
                       ...
                       <div class="bd rounded table-responsive">
                            <table class="table table-bordered mg-b-0" id="dustbinhistory-list">
    ...
    <script src="{{ url('public/frontend/js/bracket.js') }}"></script>
     ...
     <script type="text/javascript">
        ...
        var dustbin_history  = "{{ url('dustbin-history') }}";
</script>
<script src="{{ url('public/frontend/frontendjs/dustbin_history.js') }}"></script>
</body>
