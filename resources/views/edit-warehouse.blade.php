...
<body>
    ...
    <div class="br-mainpanel">      
        ...
        <form method="POST" id="update-warehouse">            
            <div class="row row-sm ">
                 <input type="hidden" name="_token" value="{{ csrf_token() }}"> 
                <div class="mg-t-20 w-100"></div>
                <div class="col-lg-12">            
                    <div class="card shadow-base bd-0 pd-25 ">
                        <h6 class="tx-inverse tx-uppercase tx-bold tx-14 mg-t-10 mg-b-15">Edit Warehouse <button onclick="location.href='{{ url('warehouse-list') }}'" class="btn btn-primary pd-x-15 pd-y-10 tx-bold tx-spacing-4 tx-12 btn-sm float-right mg-y-0-force"><div>Back</div></button> </h6>
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label class="form-control-label">Warehouse Name <span class="tx-danger">*</span></label>
                                    <input class="form-control" type="text" name="name" value="{{ $decode['result']['name'] }}" placeholder="Enter Warehouse Name" id="name">
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="mobile" value="{{ $decode['result']['mobile_no'] }}" placeholder="Enter Phone No." id="mobile" readonly>
                                     <small class="form-element-hint cus_error" style="display:none;color:red;">
    ...
    <script src="{{ url('public/frontend/frontendjs/update_warehouse.js') }}"></script>
    <script>
        var update_warehouse = "{{ env('API_URL').'updatewherehouse' }}";
        var warehouse_list   = "{{url('warehouse-list')}}";
        var lat              = "{{ $decode['result']['latitude'] }}";
        var long             = "{{ $decode['result']['longitude'] }}";
       
    </script>
<script src="{{ url('public/frontend/frontendjs/edit_warehouse.js') }}"></script>
