            ...
            <div class="row row-sm ">
                ...
                <div class="col-lg-12">            
                    <div class="card shadow-base bd-0 pd-25 ">
                        <h6 class="tx-inverse tx-uppercase tx-bold tx-14 mg-t-10 mg-b-15">Add Warehouse <button onclick="location.href='warehouse.php'" class="btn btn-primary pd-x-15 pd-y-10 tx-bold tx-spacing-4 tx-12 btn-sm float-right mg-y-0-force"><div>Back</div></button> </h6>
                        <div class="row">
                            <div class="col-lg-4">
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="latt" value="" placeholder="Enter Latitude" id="latitude">
                                     <small class="form-element-hint cus_error" style="display:none;color:red;">
                            ...
                            <div class="col-lg-4">
                                <div class="form-group mg-b-10-force">
                                    ...
                                    <input class="form-control" type="text" name="longt" value="" placeholder="Enter longitude" id="longitude">
                                     <small class="form-element-hint cus_error" style="display:none;color:red;">
